...
from src.routes.schemas.allocations import AllocationsAllocateIn, AllocationsListOut, OrderLineSchema
...
class BatchService:
    ...
    def add_batch(self, ref: str, sku: str, qty: int, eta: Optional[date] = None) -> None:
