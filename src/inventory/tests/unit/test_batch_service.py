...
from src.inventory.adapters.repository import AbstractRepository
from src.inventory.adapters.uow import AbstractUnitOfWork
from src.inventory.domain import product_model as domain
from src.inventory.services.schemas import AllocationSchemaDTO
from src.inventory.services.allocation_service import BatchService, OutOfStock
