...
from src.allocations.routes.v1.allocations import router as allocations_router_v1
from src.allocations.routes.v2.allocations import router as allocations_router_v2
...
app.include_router(allocations_router_v1)
app.include_router(allocations_router_v2)
